        ...
        if "hi" and "buddy" in query:
            ...
            # WolframAlpha this will compute math but not much effective in some cases. --Done
                ...
                try:
                    ...
                    speak(result)
                    print("Result for your query is " +result)
                except:
                    print("Sorry I can't compute it.")
            ...
            #elif "activate" and "camera" in query:
                #speak("camera mode activated")
                #print("camera mode activated")
                #camera.cameraMode()
                
            #elif "activate" and "face detection" in query:
                #speak("face detection mode activated")
                #print("face detection mode activated")
                #fd.detect_face()
