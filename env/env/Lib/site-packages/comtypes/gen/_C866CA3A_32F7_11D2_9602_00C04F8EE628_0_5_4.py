...
__all__ = [
    'DISPID_SPIElements', 'STCLocalServer', 'DISPID_SFSClose',
    'DISPID_SRGDictationSetState', 'SP_VISEME_2',
    'SAFTCCITT_uLaw_11kHzStereo', 'SSSPTRelativeToStart',
    'SPGS_DISABLED', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechObjectTokens', 'SpMemoryStream',
    'eLEXTYPE_PRIVATE12', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPPs_NewEnum', 'ISpeechObjectToken',
    'DISPID_SOTGetAttribute', 'SPEI_SOUND_END',
    'DISPID_SRAudioInputStream', 'SAFT22kHz16BitStereo', 'SVEPhoneme',
    'ISpeechPhraseInfo', 'SPCONTEXTSTATE',
    'SpeechDictationTopicSpelling', 'DISPID_SpeechPhraseRule',
    'SPPHRASE', 'SPLO_STATIC', 'SPBO_TIME_UNITS',
    'DISPIDSPTSI_ActiveOffset', 'ISpRecoContext',
    'DISPID_SDKSetBinaryValue', 'SPEI_PROPERTY_STRING_CHANGE',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechRuleState',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSTWeight',
    'DISPID_SVAlertBoundary', 'SpeechGrammarState', 'SVP_3',
    'SPEI_HYPOTHESIS', 'SGRSTTWildcard', 'DISPID_SAEventHandle',
    'DISPID_SVSyncronousSpeakTimeout', 'LONG_PTR', 'DISPID_SLPLangId',
    'ISpeechLexicon', 'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SLWLangId',
    'SPLO_DYNAMIC', 'DISPID_SVSInputWordLength', 'ISpStream',
    'DISPID_SPEs_NewEnum', 'SVPNormal', 'DISPID_SVSkip',
    'SP_VISEME_5', 'ISpeechPhraseReplacements',
    'SAFTGSM610_11kHzMono', 'SPEI_SR_RETAINEDAUDIO', 'SFTInput',
    'SPPHRASEREPLACEMENT', 'SGDSInactive', 'SpeechWordType',
    'SVEStartInputStream', 'SPWT_LEXICAL', 'SLTUser',
    'DISPID_SLPSymbolic', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SOTCreateInstance', 'DISPID_SGRSTRule',
    'ISpeechObjectTokens', 'SPPS_NotOverriden',
    'DISPID_SRCEInterference', 'SAFT8kHz16BitMono',
    'SVEEndInputStream', 'DISPID_SRCEAdaptation',
    'ISpeechLexiconPronunciation', 'SGDSActiveWithAutoPause',
    'DISPID_SGRName', 'SVP_0', 'DISPID_SGRSTransitions',
    'eLEXTYPE_PRIVATE13', 'SpeechPropertyAdaptationOn',
    'DISPID_SMSALineId', 'ISpRecoGrammar', 'DISPID_SVGetAudioOutputs',
    'SPWORD', 'SAFT32kHz8BitStereo', 'DISPID_SGRsDynamic',
    'DISPID_SRRGetXMLResult', 'SPVPRIORITY', 'DISPID_SRIsShared',
    'SASClosed', 'SAFT24kHz8BitMono', 'SVSFlagsAsync',
    'DISPID_SVSLastBookmark', 'DISPID_SpeechAudio', 'SP_VISEME_21',
    'DISPID_SRCERequestUI', 'DISPID_SRGetPropertyNumber',
    '_ISpeechVoiceEvents', 'SAFT11kHz8BitStereo', 'SPSModifier',
    'DISPID_SOTCSetId', 'SPPS_RESERVED1', 'DISPID_SpeechBaseStream',
    'SPEI_RESERVED1', 'eLEXTYPE_PRIVATE1', 'SP_VISEME_7',
    'SAFTGSM610_8kHzMono', 'DISPID_SPRsItem', 'SPAS_CLOSED',
    'DISPID_SRGetFormat', 'SAFT44kHz8BitMono', 'DISPID_SPPValue',
    'DISPID_SDKDeleteKey', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechRecoProfileProperties', 'SREFalseRecognition',
    'eLEXTYPE_PRIVATE5', 'SSFMCreate', 'ISpPhraseAlt', 'SRCS_Enabled',
    'SPWF_SRENGINE', 'DISPID_SPEDisplayAttributes',
    'DISPID_SDKGetlongValue', 'DISPID_SpeechLexiconWords',
    'SPAR_High', 'DISPID_SRCEAudioLevel', 'ISpeechLexiconWord',
    'SPCT_COMMAND', 'SRAImport', 'ISpeechRecoResultDispatch',
    'SECHighConfidence', 'ISpeechAudioBufferInfo',
    'ISpeechRecoResult2', 'SPSSuppressWord', 'ISpGrammarBuilder',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SABufferInfo', 'SGRSTTTextBuffer', 'DISPID_SVVolume',
    'SPWF_INPUT', 'SPRST_ACTIVE_ALWAYS', 'STSF_CommonAppData',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTCCITT_uLaw_22kHzMono', 'SGRSTTWord',
    'DISPID_SRCreateRecoContext', 'DISPID_SOTCategory',
    'DISPID_SRRAudioFormat', 'DISPID_SMSGetData', 'SRARoot',
    'SAFTExtendedAudioFormat', 'SPFM_OPEN_READONLY', 'SREHypothesis',
    'SPGS_EXCLUSIVE', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SWFEBlockAlign', 'SPCATEGORYTYPE', 'SSTTTextBuffer',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpDataKey',
    'DISPID_SpeechRecognizer', 'SRAONone',
    'DISPID_SRGCmdSetRuleIdState', 'SVPAlert',
    'DISPID_SRGCmdLoadFromResource', 'ISpeechFileStream',
    'SPGS_ENABLED', 'DISPID_SRCState', 'SPRULESTATE',
    'eLEXTYPE_PRIVATE11', 'STCInprocServer', 'DISPID_SPPChildren',
    'SAFTADPCM_22kHzMono', 'SP_VISEME_17', 'eLEXTYPE_PRIVATE2',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPIReplacements',
    'SPFM_OPEN_READWRITE', 'SVP_10', 'SDTRule',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPRDisplayAttributes',
    'SRCS_Disabled', 'SECNormalConfidence', 'DISPID_SRRTimes',
    'SAFT44kHz16BitMono', 'DISPID_SPIAudioSizeTime', 'SRSInactive',
    '_ISpeechRecoContextEvents', 'SVESentenceBoundary',
    'SPEI_RECO_STATE_CHANGE', 'SP_VISEME_14', 'SPLOADOPTIONS',
    'SpeechGrammarRuleStateTransitionType',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SDKEnumKeys',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCERecognition',
    'DISPID_SLWsItem', 'DISPID_SPRuleId', 'ISpSerializeState',
    'SPEI_TTS_PRIVATE', 'SP_VISEME_9', 'DISPID_SLWWord',
    'STCRemoteServer', 'SAFT11kHz16BitStereo', 'ISpPhrase',
    'SpeechVoiceSkipTypeSentence', 'SVSFIsNotXML', 'SPFILEMODE',
    'SVP_20', 'SpeechInterference', 'DISPID_SGRInitialState',
    'SDTPronunciation', 'DISPID_SLPsItem', 'SPSNotOverriden',
    'DISPID_SpeechAudioBufferInfo', 'SREAudioLevel',
    'ISpeechGrammarRules', 'SPINTERFERENCE_NONE',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGIsPronounceable',
    'DISPID_SLPType', 'DISPID_SPRFirstElement', 'SPVPRI_NORMAL',
    'SRSEIsSpeaking', 'SAFTDefault', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SBSSeek', 'STCAll', 'SPEVENT', 'SVP_13', 'SPAO_NONE',
    'DISPID_SRDisplayUI', 'SPPS_RESERVED2',
    'DISPID_SVSInputSentenceLength', 'eLEXTYPE_PRIVATE16',
    'SDKLCurrentConfig', 'DISPID_SAStatus', 'DISPID_SGRAttributes',
    'SAFT48kHz16BitStereo', 'SVSFParseAutodetect', 'SPRST_INACTIVE',
    'SPPHRASEPROPERTY', 'DISPID_SRSNumberOfActiveRules',
    'SpeechWordPronounceable', 'SP_VISEME_19', 'SPXRO_SML',
    'SPWORDLIST', 'SPPS_RESERVED4', 'eWORDTYPE_DELETED',
    'SRERecognition', 'DISPID_SDKEnumValues', 'SAFTADPCM_44kHzMono',
    'SRAInterpreter', 'SpeechDiscardType', 'DISPID_SOTRemove',
    'DISPID_SOTsCount', 'DISPID_SPIAudioSizeBytes',
    'SPRECOGNIZERSTATUS', 'DISPID_SGRSTsItem',
    'DISPID_SPRuleEngineConfidence', 'SPAUDIOBUFFERINFO',
    'DISPID_SPAStartElementInResult', 'SPEI_RECO_OTHER_CONTEXT',
    'SECFIgnoreKanaType', 'ISpResourceManager',
    'SpeechRegistryUserRoot', 'DISPID_SGRsItem',
    'DISPID_SOTGetDescription', 'eLEXTYPE_RESERVED6',
    'SpeechGrammarTagDictation', 'DISPID_SOTCDefault',
    'eLEXTYPE_PRIVATE3', 'DISPID_SLGetPronunciations',
    'DISPID_SPPName', 'SPSFunction', 'DISPID_SPIGrammarId',
    'SGSExclusive', 'SDKLLocalMachine',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechObjectToken',
    'DISPID_SABIEventBias', 'SPVOICESTATUS', 'SVSFDefault',
    'SPCT_SLEEP', 'SPEI_MIN_TTS', 'eLEXTYPE_APP', 'SP_VISEME_3',
    'SpeechCategoryAudioOut', 'SPVPRI_ALERT',
    'SpeechEngineConfidence', 'SINoSignal', 'SREAdaptation',
    'SRTReSent', 'DISPID_SLWPronunciations', 'DISPID_SOTsItem',
    'ISpRecognizer3', 'SPPARTOFSPEECH', 'SpeechVoicePriority',
    'SPWAVEFORMATTYPE', 'SVP_18', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechLexiconPronunciation', 'SREBookmark',
    'DISPID_SWFEAvgBytesPerSec', 'SDTAudio', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPAs_NewEnum', 'DISPID_SABIBufferSize',
    'DISPID_SGRAddResource', 'SITooQuiet', 'SPXRO_Alternates_SML',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRGId',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPIStartTime', 'DISPID_SOTCId',
    'SPVISEMES', 'DISPID_SRGDictationUnload', 'SVF_Stressed',
    'SP_VISEME_6', 'SpeechCategoryVoices', 'SPVPRI_OVER',
    'SPAUDIOSTATE', 'SPSNoun', 'SpInprocRecognizer',
    'DISPID_SpeechPhoneConverter', 'SAFT12kHz8BitStereo',
    'SAFTADPCM_11kHzMono', 'ISpeechObjectTokenCategory',
    'DISPID_SPPsCount', 'DISPID_SRCPause', 'DISPID_SPIRule',
    'DISPID_SGRSAddSpecialTransition', 'SINoise',
    'SpeechTokenIdUserLexicon', 'SPLEXICONTYPE',
    'DISPID_SRCRetainedAudioFormat', 'SpMMAudioIn', 'SVEViseme',
    'DISPIDSPTSI_SelectionLength', 'SPBO_AHEAD', 'eLEXTYPE_PRIVATE14',
    'eLEXTYPE_PRIVATE15', 'SSFMOpenForRead', 'SRSEDone',
    'DISPID_SASFreeBufferSpace', 'Speech_StreamPos_RealTime',
    'SRADynamic', 'SPEI_MAX_TTS', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVGetProfiles', 'SP_VISEME_4', 'SpMMAudioEnum',
    'SBOPause', 'SGLexical', 'DISPIDSPTSI', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechDataKey', 'ISpRecognizer2', 'ISpeechAudioStatus',
    'DISPID_SpeechLexiconWord', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPRuleConfidence',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_RECOGNITION',
    'DISPID_SOTIsUISupported', 'ISpeechPhoneConverter',
    'DISPID_SVDisplayUI', 'SDKLDefaultLocation',
    'SpTextSelectionInformation', 'DISPID_SPEAudioStreamOffset',
    'SPPS_LMA', 'ISpeechPhraseAlternate', 'SRAORetainAudio', 'SVP_4',
    'ISpNotifySource', 'SPINTERFERENCE', 'DISPID_SLWsCount',
    'SPEI_START_INPUT_STREAM', 'ISpeechCustomStream',
    'DISPID_SRCSetAdaptationData', 'SPPS_RESERVED3',
    'DISPID_SpeechVoiceEvent', 'eLEXTYPE_RESERVED7',
    'eLEXTYPE_RESERVED8', 'DISPID_SDKCreateKey',
    'SpeechTokenShellFolder', 'SPPROPERTYINFO',
    'DISPID_SpeechGrammarRuleState', 'SpeechDataKeyLocation',
    'SP_VISEME_18', 'SP_VISEME_20', 'IInternetSecurityManager',
    'SPSEMANTICERRORINFO', 'SGPronounciation', 'DISPID_SBSWrite',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRsCommit', 'SPEI_ADAPTATION', 'SDTAll',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRRSaveToMemory',
    'DISPID_SRRRecoContext', 'DISPID_SPPConfidence',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechMicTraining',
    'DISPID_SPRules_NewEnum', 'SPEI_SOUND_START',
    'SpeechAudioProperties', 'DISPID_SRProfile',
    'DISPID_SRSAudioStatus', 'SDTProperty', 'DISPID_SRGState',
    'SpeechGrammarWordType', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPPNumberOfElements', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SBSFormat', 'SPEI_START_SR_STREAM', 'ISpObjectToken',
    'DISPID_SABIMinNotification', 'DISPID_SPIGetDisplayAttributes',
    'SWPUnknownWordPronounceable', 'SPAS_STOP', 'IEnumString',
    'SPDKL_CurrentUser', 'SVSFParseSsml', 'SVP_9',
    ...
    'SpeechPartOfSpeech', 'DISPID_SRGRules', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechPhraseRules', 'DISPID_SPPFirstElement',
    'DISPID_SLPsCount', 'SP_VISEME_10',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechVoice',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechCategoryRecognizers',
    'SP_VISEME_0', 'SREPrivate', 'DISPID_SPRuleChildren',
    'DISPID_SGRSTPropertyValue', 'SPSHT_Unknown', 'eLEXTYPE_USER',
    'SP_VISEME_15', 'eLEXTYPE_PRIVATE7', 'SREStateChange',
    'SPFM_CREATE', 'SPEI_RESERVED2', 'SpeechVisemeFeature',
    'ISpeechGrammarRule', 'SVEWordBoundary',
    'SWPUnknownWordUnpronounceable', 'ISpNotifySink',
    'SpObjectTokenCategory', 'SPEI_WORD_BOUNDARY', 'SpAudioFormat',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SASetState',
    'SPRS_ACTIVE', 'SRATopLevel', 'Speech_StreamPos_Asap',
    'DISPID_SRCBookmark', 'SGRSTTDictation', 'eLEXTYPE_PRIVATE4',
    'DISPID_SAVolume', 'DISPID_SpeechAudioStatus', 'SRTSMLTimeout',
    'DISPID_SRGCommit', 'SRSActiveAlways', 'SAFTADPCM_22kHzStereo',
    'SGSEnabled', 'DISPID_SDKGetBinaryValue', 'eLEXTYPE_PRIVATE19',
    'ISpRecoGrammar2', 'ISpeechPhraseProperties',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRGReset',
    'SpPhoneConverter', 'DISPID_SpeechPhraseAlternate',
    'SPPS_Noncontent', 'ISpEventSource', 'DISPID_SRCEStartStream',
    'ISpShortcut', 'ISpLexicon', 'SP_VISEME_13', 'SpeechRecoEvents',
    'ISpStreamFormat', 'DISPID_SVEventInterests',
    'SPSERIALIZEDPHRASE', 'SVP_2', 'DISPID_SVRate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPBOOKMARKOPTIONS',
    'ISpVoice', 'DISPID_SDKSetLongValue', 'SpWaveFormatEx',
    'DISPID_SWFESamplesPerSec', 'DISPID_SGRsCommitAndSave',
    'SpeechVoiceSpeakFlags', 'SPWT_DISPLAY', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRCERecognizerStateChange', 'SRERequestUI', 'SLOStatic',
    'SpNotifyTranslator', 'SPSTREAMFORMATTYPE',
    'DISPID_SRRTTickCount', 'SpeechRecoContextState',
    'DISPID_SRCEHypothesis', 'DISPID_SRGRecoContext',
    'DISPID_SAFGetWaveFormatEx', 'SPRS_INACTIVE',
    'DISPID_SPRuleParent', 'SPEI_INTERFERENCE', 'SpeechAudioVolume',
    'SPCT_SUB_COMMAND', 'ISpeechAudioFormat', 'WAVEFORMATEX',
    'DISPID_SCSBaseStream', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPISaveToMemory', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPGRAMMARSTATE', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPEActualConfidence', 'SPAR_Medium',
    'SpNullPhoneConverter', 'SGRSTTEpsilon', 'SDTLexicalForm',
    'DISPID_SVPause', 'SAFT24kHz16BitMono', 'SAFTCCITT_uLaw_8kHzMono',
    'SPEI_SR_BOOKMARK', 'DISPID_SpeechAudioFormat',
    'DISPID_SVEViseme', 'SpObjectToken', 'SAFT24kHz8BitStereo',
    'SAFTText', 'SpeechStreamFileMode', 'SPEI_RESERVED5',
    'SVSFVoiceMask', 'DISPID_SPACommit', 'ISpeechPhraseReplacement',
    'DISPID_SLGetWords', 'SPRST_NUM_STATES', 'DISPID_SVStatus',
    'DISPID_SRSetPropertyString', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRTStandard',
    'DISPID_SVResume', 'DISPID_SVSLastResult', 'SECFEmulateResult',
    'SpeechRecognizerState', 'SPSHORTCUTTYPE',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRSClsidEngine',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechLexiconProns',
    'DISPID_SPRs_NewEnum', 'SpPhoneticAlphabetConverter',
    'SpeechGrammarTagWildcard', 'DISPID_SVEPhoneme',
    'SpCompressedLexicon', 'SVSFUnusedFlags', 'SAFT44kHz16BitStereo',
    'SpStreamFormatConverter', 'SPPS_Modifier', 'ISpRecoCategory',
    'SAFT16kHz16BitMono', 'SGLexicalNoSpecialChars',
    'SpeechRegistryLocalMachineRoot', 'Speech_Default_Weight',
    'ISpObjectWithToken', '_SPAUDIOSTATE', 'DISPID_SVEVoiceChange',
    'SVP_17', 'ISpPhoneticAlphabetSelection', 'SAFT48kHz16BitMono',
    'SpeechAudioFormatType', 'SRAExport', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SGRSTText', 'SDTReplacement', 'tagSPTEXTSELECTIONINFO',
    'ISequentialStream', 'DISPID_SRRSetTextFeedback', 'SRTAutopause',
    'SPAUDIOSTATUS', 'DISPID_SAFGuid', 'SpInProcRecoContext',
    'SPEI_PHONEME', 'DISPID_SpeechMMSysAudio',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SDTDisplayText',
    'DISPID_SDKGetStringValue', 'DISPID_SOTDisplayUI',
    'SpeechDisplayAttributes', 'SSSPTRelativeToEnd',
    'SAFT8kHz8BitStereo', 'SpeechGrammarTagUnlimitedDictation',
    'SREPropertyNumChange', 'SPAUDIOOPTIONS',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpObjectTokenCategory',
    'ISpProperties', 'DISPID_SOTId', 'DISPID_SPEEngineConfidence',
    'SPEI_MIN_SR', 'DISPID_SVGetVoices', 'SAFT11kHz16BitMono',
    'DISPID_SRCEPhraseStart', 'DISPID_SWFEBitsPerSample',
    ...
    'SpeechCategoryAudioIn', 'SPDKL_DefaultLocation',
    'SVSFPurgeBeforeSpeak', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SREInterference', 'eLEXTYPE_PRIVATE20', 'DISPID_SPRsCount',
    'DISPID_SVIsUISupported', 'SPWORDPRONOUNCEABLE',
    'STSF_LocalAppData', 'SPEI_SENTENCE_BOUNDARY',
    'SAFT44kHz8BitStereo', 'SPDKL_LocalMachine',
    'SPTEXTSELECTIONINFO', 'DISPID_SPRuleName', 'DISPID_SFSOpen',
    'DISPID_SpeechXMLRecoResult', 'SAFTCCITT_uLaw_11kHzMono', 'SVP_5',
    'SVP_11', 'SVEPrivate', 'SPRECOCONTEXTSTATUS',
    'DISPID_SpeechGrammarRules', 'SPPS_Noun', 'DISPID_SVEBookmark',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPEsItem', 'SPSUnknown', 'DISPID_SpeechLexicon',
    'DISPID_SADefaultFormat', 'DISPID_SpeechMemoryStream',
    'SDA_No_Trailing_Space', 'DISPID_SRGetRecognizers', 'SP_VISEME_8',
    'DISPIDSPRG', 'SpeechPropertyResourceUsage',
    'DISPID_SGRsFindRule', 'ISpeechRecoResultTimes', 'SpLexicon',
    'SPAS_RUN', 'DISPID_SVSpeak', 'DISPID_SPRNumberOfElements',
    'SSTTDictation', 'DISPID_SPPsItem', 'SpeechVoiceEvents',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRCEBookmark',
    'SVSFNLPSpeakPunc', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPEVENTENUM', 'ISpeechPhraseElements', 'SPSEMANTICFORMAT',
    'DISPID_SVWaitUntilDone', 'ISpeechAudio', 'SPEI_PHRASE_START',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT32kHz8BitMono',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SLRemovePronunciation',
    'ISpeechRecoGrammar', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_FALSE_RECOGNITION', 'SREStreamStart', 'SDKLCurrentUser',
    'SPWT_PRONUNCIATION', 'SITooLoud', 'ISpeechDataKey',
    'SAFT22kHz8BitMono', 'DISPID_SLAddPronunciationByPhoneIds',
    'SINone', 'SpeechEmulationCompareFlags', 'SLODynamic', 'SVP_21',
    'ISpeechPhraseElement', 'DISPID_SRCEFalseRecognition', 'SVP_15',
    'SP_VISEME_16', 'DISPID_SVSCurrentStreamNumber',
    'SpeechLexiconType', 'DISPID_SOTDataKey', 'SAFT12kHz16BitMono',
    'DISPID_SGRId', 'ISpeechLexiconPronunciations',
    'SpeechCategoryPhoneConverters', 'eWORDTYPE_ADDED', 'SVSFIsXML',
    'SDA_Consume_Leading_Spaces', 'SPRECORESULTTIMES',
    'SpeechVisemeType', 'SpVoice', 'SpeechStreamSeekPositionType',
    'SGRSTTRule', 'ISpRecoContext2', 'SPBINARYGRAMMAR',
    'SRTExtendableParse', 'DISPIDSPTSI_ActiveLength',
    'SpeechAllElements', 'DISPID_SRGetPropertyString', 'SVP_19',
    'DISPID_SPCIdToPhone', 'DISPID_SVSRunningState',
    'SAFT8kHz8BitMono', 'SDA_Two_Trailing_Spaces',
    'DISPID_SOTCGetDataKey', 'DISPID_SGRsCount',
    ...
    'SVSFIsFilename', 'SpeechAudioFormatGUIDText',
    'DISPID_SRCVoicePurgeEvent', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPIEngineId', 'ISpeechMMSysAudio',
    'DISPID_SABufferNotifySize', 'ISpRecoResult',
    'DISPID_SRCRecognizer', 'SFTSREngine',
    'DISPID_SpeechPhraseElements', 'eLEXTYPE_PRIVATE8',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPWORDTYPE',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRGSetWordSequenceData',
    'SITooSlow', 'SAFT32kHz16BitStereo',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpStream',
    'SpeechVoiceCategoryTTSRate', 'SAFT12kHz16BitStereo',
    'DISPID_SRSCurrentStreamPosition',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRCRequestedUIType', 'ISpeechRecoContext', 'SGDisplay',
    'SpSharedRecoContext', 'SSFMCreateForWrite',
    'DISPID_SLPs_NewEnum', 'SAFTCCITT_ALaw_8kHzMono', 'SVSFParseSapi',
    'ISpeechRecognizerStatus', 'SAFT11kHz8BitMono',
    'DISPID_SRRTLength', 'IStream', 'DISPID_SDKOpenKey',
    'SGSDisabled', 'DISPID_SRRPhraseInfo', 'SVEAudioLevel',
    'DISPID_SpeechWaveFormatEx', 'SPSVerb', 'ISpeechBaseStream',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPPEngineConfidence', 'DISPID_SRSetPropertyNumber',
    'SpCustomStream', 'DISPID_SLWType', 'SAFT22kHz8BitStereo',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVSInputWordPosition',
    'DISPID_SpeechRecoResult', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFT12kHz8BitMono', 'SWTDeleted', 'ISpeechVoice',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SLGenerationId',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRGSetTextSelection',
    'DISPID_SOTSetId', 'SPAR_Low', 'SRSActive', 'DISPID_SPEsCount',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_MAX_SR', 'DISPID_SVEWord',
    'DISPID_SASCurrentSeekPosition', 'SAFTADPCM_8kHzMono',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SAFType', 'SPSInterjection',
    'ISpeechTextSelectionInformation', 'SpPhraseInfoBuilder',
    'SpeechTokenValueCLSID', 'SAFTNoAssignedFormat',
    'DISPID_SPRulesCount', 'DISPID_SPCLangId', 'eLEXTYPE_PRIVATE18',
    'STSF_FlagCreate', 'DISPID_SpeechPhraseReplacements',
    'SVF_Emphasis', 'DISPID_SRRecognizer', 'SGDSActive',
    'DISPID_SGRSTPropertyName', 'SDA_One_Trailing_Space',
    'SVEBookmark', 'ISpeechGrammarRuleState', 'SpeechAudioState',
    'DISPID_SRCEEndStream', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPRuleFirstElement', 'SPPS_Interjection',
    'SPINTERFERENCE_TOOFAST', 'SPSHT_NotOverriden',
    'DISPID_SVEAudioLevel', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRStatus', 'SPEVENTSOURCEINFO', 'SPFM_CREATE_ALWAYS',
    'SSTTWildcard', 'DISPID_SGRsAdd', 'SpeechLoadOption',
    'eLEXTYPE_PRIVATE10', 'SPEI_UNDEFINED', 'SPCT_DICTATION',
    'SDTAlternates', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRCEventInterests', 'ISpeechRecognizer', 'SPAS_PAUSE',
    'DISPID_SMSAMMHandle', 'SpeechTokenKeyAttributes',
    'DISPID_SpeechPhraseAlternates', 'SPEI_SR_PRIVATE',
    'DISPID_SGRSTsCount', 'DISPID_SVSVisemeId',
    'DISPID_SRRAlternates', 'DISPID_SRIsUISupported',
    'SPSHORTCUTPAIR', 'DISPID_SGRSAddWordTransition', 'tagSTATSTG',
    'DISPID_SRRAudio', 'SVPOver', 'ISpeechPhraseAlternates',
    'DISPID_SVSInputSentencePosition', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SVAudioOutputStream',
    'SAFT24kHz16BitStereo', 'UINT_PTR', 'SAFT48kHz8BitStereo',
    'DISPID_SPPParent', 'SP_VISEME_1', 'DISPID_SRGDictationLoad',
    'DISPID_SpeechPhraseElement', 'ISpRecognizer',
    'DISPID_SGRAddState', 'SAFTCCITT_ALaw_22kHzMono', 'SpMMAudioOut',
    'SpeechTokenContext', 'SPSHT_EMAIL', 'SVP_6',
    'DISPID_SLWs_NewEnum', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPILanguageId', 'DISPID_SPPId', 'DISPID_SVAudioOutput',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRAudioInput',
    'DISPID_SVEStreamEnd', 'SREPropertyStringChange',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRSRule', 'SAFT16kHz16BitStereo',
    'DISPID_SWFEFormatTag', 'DISPID_SPCPhoneToId',
    'DISPID_SMSSetData', 'SVEAllEvents', 'DISPID_SPEDisplayText',
    'SP_VISEME_12', 'SPSLMA', 'DISPID_SPIProperties',
    'SGDSActiveUserDelimited', 'ISpPhoneConverter',
    'SPEI_VOICE_CHANGE', 'DISPID_SGRSTType', 'SECFNoSpecialChars',
    'SpeechCategoryRecoProfiles',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SpeechPhraseInfo',
    'SPGRAMMARWORDTYPE', 'SpeechRunState', 'SVF_None', 'SP_VISEME_11',
    'DISPID_SOTRemoveStorageFileName', 'ISpeechRecoResult',
    'SAFT16kHz8BitMono', 'SPPHRASERULE', 'ISpeechVoiceStatus',
    'DISPID_SPEPronunciation', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SASState', 'DISPID_SDKSetStringValue',
    'ISpeechMemoryStream', 'DISPID_SPIGetText', 'DISPID_SGRClear',
    'SPEI_VISEME', 'DISPID_SPIRetainedSizeBytes', 'SRESoundStart',
    'SPCS_DISABLED', 'DISPID_SRCCreateGrammar', 'ISpEventSink',
    'ISpeechPhraseProperty', 'DISPID_SASNonBlockingIO',
    'SpeechBookmarkOptions', 'SPCS_ENABLED', 'SPFM_NUM_MODES',
    'SPSHT_OTHER', 'ISpXMLRecoResult', 'SVP_7', 'SECLowConfidence',
    'SLTApp', 'eLEXTYPE_PRIVATE17', 'SPBO_PAUSE',
    'DISPID_SVGetAudioInputs', 'SPEI_RESERVED6', 'SREStreamEnd',
    'DISPID_SPERetainedStreamOffset', 'SRTEmulated',
    'SpeechCategoryAppLexicons', 'SPEI_RESERVED3', 'SITooFast',
    'DISPID_SpeechFileStream', 'SVP_12', 'SpResourceManager',
    'DISPID_SPAPhraseInfo', 'SBONone', 'SPRST_INACTIVE_WITH_PURGE',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_PROPERTY_NUM_CHANGE',
    'STSF_AppData', 'SPWORDPRONUNCIATION', 'DISPID_SPAsItem',
    'SREPhraseStart', 'SPEI_TTS_BOOKMARK', 'eLEXTYPE_PRIVATE9',
    'SASStop', 'DISPID_SVESentenceBoundary', 'SRESoundEnd',
    'SpSharedRecognizer', 'SECFIgnoreWidth', 'DISPID_SPRText',
    'SpeechRecognitionType', 'eLEXTYPE_RESERVED4',
    'DISPID_SWFEExtraData', 'SAFT22kHz16BitMono', 'SVP_16',
    'DISPID_SWFEChannels', 'SpeechTokenKeyFiles', '_RemotableHandle',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SBSRead',
    'SpeechAudioFormatGUIDWave', 'DISPID_SPRulesItem',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCESoundStart',
    ...
    'SPPHRASEELEMENT', 'ISpAudio', 'SpeechPropertyResponseSpeed',
    'SRADefaultToActive', 'SPRST_ACTIVE', 'SECFIgnoreCase',
    'SASPause', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SOTCEnumerateTokens',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRState',
    'SAFTGSM610_44kHzMono', 'SPRECOSTATE', 'DISPID_SVVoice',
    'DISPID_SVSLastStreamNumberQueued', 'SVP_8',
    'DISPID_SDKDeleteValue', 'SPEI_END_SR_STREAM', 'SVSFParseMask',
    '__MIDL_IWinTypes_0009', 'SAFT8kHz16BitStereo',
    'STCInprocHandler', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SLGetGenerationChange',
    'DISPID_SpeechRecoResult2', 'SPSHORTCUTPAIRLIST',
    'ISpeechWaveFormatEx', 'SpShortcut', 'IEnumSpObjectTokens',
    'SVP_14', 'DISPID_SRGCmdLoadFromFile', 'SPINTERFERENCE_NOISE',
    'SPPS_Verb', 'DISPID_SPAsCount', 'SPRULE', 'SPEI_REQUEST_UI',
    'SRERecoOtherContext', 'DISPID_SVSpeakStream',
    'SPDKL_CurrentConfig', 'DISPID_SPARecoResult',
    'DISPID_SRCESoundEnd', 'SPBO_NONE', 'SpFileStream',
    'SPSERIALIZEDRESULT', 'DISPID_SRRTOffsetFromStart', 'SVP_1',
    'DISPID_SPELexicalForm', 'DISPID_SLPPhoneIds',
    'Speech_Max_Pron_Length', 'DISPID_SVPriority',
    'DISPID_SMSADeviceId', 'SREAllEvents', 'SPDATAKEYLOCATION',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechSpecialTransitionType',
    'ISpStreamFormatConverter', 'ISpeechPhraseInfoBuilder',
    'IInternetSecurityMgrSite', 'ISpNotifyTranslator',
    'SAFTCCITT_ALaw_8kHzStereo', 'eLEXTYPE_RESERVED10', 'SPSMF_UPS',
    'ISpeechPhraseRules', 'ISpMMSysAudio', 'SSFMOpenReadWrite',
    'SAFT32kHz16BitMono', 'SVEVoiceChange', 'SECFDefault',
    'ISpeechResourceLoader', 'SpeechAddRemoveWord',
    'DISPID_SpeechRecoContext', 'SVSFPersistXML',
    'DISPID_SGRs_NewEnum', 'SAFT48kHz8BitMono', 'ISpeechLexiconWords',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_Unknown',
    'DISPID_SRRTStreamTime', 'SPPS_Function',
    'Speech_Max_Word_Length', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRCResume', 'DISPID_SREmulateRecognition', 'SVSFNLPMask',
    'SWPKnownWordPronounceable', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCRetainedAudio', 'SPINTERFERENCE_NOSIGNAL',
    'ISpeechPhraseRule', 'DISPID_SVEStreamStart',
    'SPCT_SUB_DICTATION', 'SASRun', 'SpeechEngineProperties',
    'tagSPPROPERTYINFO', 'SAFTNonStandardFormat',
    'SRSInactiveWithPurge', 'SWTAdded',
